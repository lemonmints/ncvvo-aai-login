    ...
    public class Saml20SignonHandler : Saml20AbstractEndpointHandler
    {
        ...
        private void HandleResponse(HttpContext context)
        {
            ...
            try
            {
                ...
                AuditLogging.logEntry(Direction.IN, Operation.LOGIN, "BOOKMARK 1");
                ...
                AuditLogging.logEntry(Direction.IN, Operation.LOGIN, "BOOKMARK 2");
                HandleAssertion(context, assertion);
                return;
            }
            catch (Exception e)
        ...
        private void HandleAssertion(HttpContext context, XmlElement elem)
        {
            ...
            AuditLogging.logEntry(Direction.IN, Operation.LOGIN, "BOOKMARK HandleAssertion");
        ...
        {
            AuditLogging.logEntry(Direction.IN, Operation.LOGIN, "BOOKMARK Do Login");
